...
import io.kodokojo.bdd.stage.AccessRestThen;
import io.kodokojo.bdd.stage.AccessRestWhen;
...
@API
public class AccessRestIntTest extends ScenarioTest<ApiGiven<?>, AccessRestWhen<?>, AccessRestThen<?>> {
